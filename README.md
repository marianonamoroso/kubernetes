...
<h1>Kubernetes</h1>
This repository contains helpful use commands, exercises for preparing CKA and CKAD. Also, I created the kube-response tool giving you shortcuts for listing and exporting information of your nodes, pods and deployments via cli without memorizing some options with kubectl<br>
